            ...
            <div className="md:grid grid-cols-5 md:gap-4">
              ...
              <div className="md:col-span-3 bg-white md:shadow-lg shadow-gray-400 p-3 md:rounded-[20px] ">
                ...
                <div className="text-left  text-[13px] font-semibold mt-4 text-[#114369] ">
                  ...
                  consectetur adipiscing elit. Sed senectus duis diam Lorem
                  ipsum dolor sit amet, consectetur adipiscing elit. Sed
                  senectus. Lorem ipsum dolor sit amet, consectetur adipiscing
                  elit. Sed senectus duis diam Lorem ipsum dolor sit amet,
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-black text-[10px] font-thin   ">
                      ...
                      holding company and financial services corporation based
                ...
                <div className="flex items-center space-x-3">
                  <div>
                    ...
                    <div className="text-black text-[12px] font-thin mt-2   ">
                      ...
                      <div>John Smith</div>
                      <div>johnsmith@smz.org</div>
                      <div>(777) 777 7777</div>

                      <div className="font-normal mt-4">
                        Network :{" "}
                        <span className="font-thin">Fifth Ward CRC</span>{" "}
                      </div>
                      ...
                      <div className="font-normal mt-4">
                        ...
                        <span className="font-thin">
                          ...
                          elit. Sed senectus duis diam Lorem ipsum dolor sit
