    ...
    return (
      <div className="bg-white py-[20px] pb-[80px] px-[30px] md:rounded-[18px] shadow-lg">
        ...
        <div className="space-y-2 mt-4">
          ...
          <div className="bg-[#EBF1F5] px-4 py-3 rounded-[5px] space-y-2">
              <div  className="text-[14px]"> Message{" "} <span className="text-black font-thin text-[12px] ">(Your Email Content)  </span></div>
              <InputBase
              sx={{
                bgcolor: "white",
                pl: 3,
          ...
          <div className="bg-[#EBF1F5] px-4 py-3 rounded-[5px] space-y-2">
              <div  className="text-[14px]"> Schedule your Email Campaign </div>
              <ReactSelect
              styles={style}
